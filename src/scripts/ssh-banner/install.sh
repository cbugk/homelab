...
chown root:root ./ssh-banner-header.txt
chown root:root ./ssh-banner-footer.txt
chown root:root ./ssh-banner.sh
chown root:root ./ssh-banner.service

chmod 644 ./ssh-banner-header.txt
chmod 644 ./ssh-banner-footer.txt
